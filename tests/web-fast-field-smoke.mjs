...
const loader=read('app/v11_2/index.html'),fast=read('app/v11_2/fast-field.js'),ocr=read('app/v11_2/fast-ocr-engine.js'),tax=read('app/v11_2/sign-taxonomy.js'),webxr=read('app/v11_2/webxr-measurement.js'),sw=read('app/v11_2/service-worker.js');
const required=[
  [loader,'FAST FIELD 11.2.5'],[loader,'fast-field.js?b=11.2.5'],[loader,'fast-ocr-engine.js?b=11.2.5'],[loader,'sign-taxonomy.js?b=11.2.5'],[loader,'webxr-measurement.js?b=11.2.5'],
  ...
  [webxr,"requestSession('immersive-ar'"],[webxr,"requiredFeatures:['hit-test']"],[webxr,"'depth-sensing'"],[webxr,'WebXR-HitTest-3D'],
  [sw,'tabela-ai-v11-2-11.2.5-webxr-bridge'],[sw,'./webxr-measurement.js']
];
for(const [text,token] of required)if(!text.includes(token))throw new Error('V11.2.5 contract missing: '+token);
...
console.log('V11.2.5 FAST FIELD WebXR pre-detect/premeasure manual-photo OCR smoke test OK');