...
const required=[
  ...
  [ocr,"createWorker('tur+eng'"],[ocr,'singlePass:true'],[ocr,'TURKISH_ALPHABET'],[ocr,'TARGET_MS=3000'],[ocr,'apple-vision'],[ocr,'tr-TR+en-US'],[ocr,'darkBackground'],[ocr,'strongWordText'],[ocr,'tessedit_pageseg_mode:\'11\''],
  ...
  [sw,'tabela-ai-v11-2-11.2.7-stable-roi-ocr'],[sw,'./field-diagnostics.js']
];
for(const [text,token] of required)if(!text.includes(token))throw new Error('V11.2.7 contract missing: '+token);
...
console.log('V11.2.7 FAST FIELD stable ROI + Turkish OCR smoke test OK');