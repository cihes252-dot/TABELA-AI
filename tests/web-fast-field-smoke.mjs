...
const required=[
  [loader,'FAST FIELD 11.2.9'],[loader,'fast-field.js?b=11.2.9'],[loader,'fast-ocr-engine.js?b=11.2.9'],[loader,'field-accuracy-fix.js?b=11.2.9'],[loader,'sign-taxonomy.js?b=11.2.9'],[loader,'webxr-measurement.js?b=11.2.9'],[loader,'field-diagnostics.js?b=11.2.9'],[loader,'OCR sonucu burada görünecek'],
  ...
  [accuracy,'adaptive-single-pass-text-band'],[accuracy,'lowConfidenceRejected'],[accuracy,'confidence>=70'],[accuracy,'Güven 70 altında'],
  ...
  [sw,'tabela-ai-v11-2-11.2.9-field-accuracy'],[sw,'./field-accuracy-fix.js']
];
for(const [text,token] of required)if(!text.includes(token))throw new Error('V11.2.9 contract missing: '+token);
...
console.log('V11.2.9 FAST FIELD field accuracy smoke test OK');