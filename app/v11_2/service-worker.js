const CACHE='tabela-ai-v11-2-11.2.12-manual-ocr-roi';
const CORE=[
  './','./index.html','./manifest.webmanifest','./sign-taxonomy.js','./fast-ocr-engine.js','./ocr-roi-guard.js','./field-accuracy-fix.js','./webxr-measurement.js','./fast-field.js','./manual-ocr-roi.js','./field-diagnostics.js','./camera-clean-ui.js','./field-runtime-fix.js',
